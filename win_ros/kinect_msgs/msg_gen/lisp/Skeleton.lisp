...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Skeleton>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 32) (cl:slot-value msg 'tracking_id)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 40) (cl:slot-value msg 'tracking_id)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 48) (cl:slot-value msg 'tracking_id)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 56) (cl:slot-value msg 'tracking_id)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 32) (cl:slot-value msg 'enrollment_index)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 40) (cl:slot-value msg 'enrollment_index)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 48) (cl:slot-value msg 'enrollment_index)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 56) (cl:slot-value msg 'enrollment_index)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 32) (cl:slot-value msg 'user_index)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 40) (cl:slot-value msg 'user_index)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 48) (cl:slot-value msg 'user_index)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 56) (cl:slot-value msg 'user_index)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 32) (cl:slot-value msg 'quality_flag)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 40) (cl:slot-value msg 'quality_flag)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 48) (cl:slot-value msg 'quality_flag)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 56) (cl:slot-value msg 'quality_flag)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Skeleton>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'skeleton_tracking_state) istream)
    ...
    (cl:setf (cl:ldb (cl:byte 8 32) (cl:slot-value msg 'tracking_id)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 40) (cl:slot-value msg 'tracking_id)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 48) (cl:slot-value msg 'tracking_id)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 56) (cl:slot-value msg 'tracking_id)) (cl:read-byte istream))
    ...
    (cl:setf (cl:ldb (cl:byte 8 32) (cl:slot-value msg 'enrollment_index)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 40) (cl:slot-value msg 'enrollment_index)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 48) (cl:slot-value msg 'enrollment_index)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 56) (cl:slot-value msg 'enrollment_index)) (cl:read-byte istream))
    ...
    (cl:setf (cl:ldb (cl:byte 8 32) (cl:slot-value msg 'user_index)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 40) (cl:slot-value msg 'user_index)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 48) (cl:slot-value msg 'user_index)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 56) (cl:slot-value msg 'user_index)) (cl:read-byte istream))
  ...
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
    ...
    (cl:setf (cl:ldb (cl:byte 8 32) (cl:slot-value msg 'quality_flag)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 40) (cl:slot-value msg 'quality_flag)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 48) (cl:slot-value msg 'quality_flag)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 56) (cl:slot-value msg 'quality_flag)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Skeleton>)))
  ...
  "c36e53ab36dd280a1c60d91e51415e29")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Skeleton)))
  "Returns md5sum for a message object of type 'Skeleton"
  "c36e53ab36dd280a1c60d91e51415e29")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Skeleton>)))
  ...
  (cl:format cl:nil "SkeletonTrackingState skeleton_tracking_state~%uint64 tracking_id~%uint64 enrollment_index~%uint64 user_index~%geometry_msgs/Transform position~%geometry_msgs/Transform[] skeleton_positions~%SkeletonPositionTrackingState[] skeleton_position_tracking_state~%uint64 quality_flag~%~%int8 NUI_SKELETON_POSITION_HIP_CENTER = 0~%int8 NUI_SKELETON_POSITION_SPINE = 1~%int8 NUI_SKELETON_POSITION_SHOULDER_CENTER = 2~%int8 NUI_SKELETON_POSITION_HEAD = 3~%int8 NUI_SKELETON_POSITION_SHOULDER_LEFT = 4~%int8 NUI_SKELETON_POSITION_ELBOW_LEFT = 5~%int8 NUI_SKELETON_POSITION_WRIST_LEFT = 6~%int8 NUI_SKELETON_POSITION_HAND_LEFT = 7~%int8 NUI_SKELETON_POSITION_SHOULDER_RIGHT = 8~%int8 NUI_SKELETON_POSITION_ELBOW_RIGHT = 9~%int8 NUI_SKELETON_POSITION_WRIST_RIGHT = 10~%int8 NUI_SKELETON_POSITION_HAND_RIGHT = 11~%int8 NUI_SKELETON_POSITION_HIP_LEFT = 12~%int8 NUI_SKELETON_POSITION_KNEE_LEFT = 13~%int8 NUI_SKELETON_POSITION_ANKLE_LEFT = 14~%int8 NUI_SKELETON_POSITION_FOOT_LEFT = 15~%int8 NUI_SKELETON_POSITION_HIP_RIGHT = 16~%int8 NUI_SKELETON_POSITION_KNEE_RIGHT = 17~%int8 NUI_SKELETON_POSITION_ANKLE_RIGHT = 18~%int8 NUI_SKELETON_POSITION_FOOT_RIGHT = 19~%int8 NUI_SKELETON_POSITION_COUNT = 20~%~%================================================================================~%MSG: kinect_msgs/SkeletonTrackingState~%int8 NUI_SKELETON_NOT_TRACKED = 0~%int8 NUI_SKELETON_POSITION_ONLY = 1~%int8 NUI_SKELETON_TRACKED = 2~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: kinect_msgs/SkeletonPositionTrackingState~%int8 NUI_SKELETON_POSITION_NOT_TRACKED = 0~%int8 NUI_SKELETON_POSITION_INFERRED = 1~%int8 NUI_SKELETON_POSITION_TRACKED = 2~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Skeleton)))
  "Returns full string definition for message of type 'Skeleton"
  (cl:format cl:nil "SkeletonTrackingState skeleton_tracking_state~%uint64 tracking_id~%uint64 enrollment_index~%uint64 user_index~%geometry_msgs/Transform position~%geometry_msgs/Transform[] skeleton_positions~%SkeletonPositionTrackingState[] skeleton_position_tracking_state~%uint64 quality_flag~%~%int8 NUI_SKELETON_POSITION_HIP_CENTER = 0~%int8 NUI_SKELETON_POSITION_SPINE = 1~%int8 NUI_SKELETON_POSITION_SHOULDER_CENTER = 2~%int8 NUI_SKELETON_POSITION_HEAD = 3~%int8 NUI_SKELETON_POSITION_SHOULDER_LEFT = 4~%int8 NUI_SKELETON_POSITION_ELBOW_LEFT = 5~%int8 NUI_SKELETON_POSITION_WRIST_LEFT = 6~%int8 NUI_SKELETON_POSITION_HAND_LEFT = 7~%int8 NUI_SKELETON_POSITION_SHOULDER_RIGHT = 8~%int8 NUI_SKELETON_POSITION_ELBOW_RIGHT = 9~%int8 NUI_SKELETON_POSITION_WRIST_RIGHT = 10~%int8 NUI_SKELETON_POSITION_HAND_RIGHT = 11~%int8 NUI_SKELETON_POSITION_HIP_LEFT = 12~%int8 NUI_SKELETON_POSITION_KNEE_LEFT = 13~%int8 NUI_SKELETON_POSITION_ANKLE_LEFT = 14~%int8 NUI_SKELETON_POSITION_FOOT_LEFT = 15~%int8 NUI_SKELETON_POSITION_HIP_RIGHT = 16~%int8 NUI_SKELETON_POSITION_KNEE_RIGHT = 17~%int8 NUI_SKELETON_POSITION_ANKLE_RIGHT = 18~%int8 NUI_SKELETON_POSITION_FOOT_RIGHT = 19~%int8 NUI_SKELETON_POSITION_COUNT = 20~%~%================================================================================~%MSG: kinect_msgs/SkeletonTrackingState~%int8 NUI_SKELETON_NOT_TRACKED = 0~%int8 NUI_SKELETON_POSITION_ONLY = 1~%int8 NUI_SKELETON_TRACKED = 2~%~%================================================================================~%MSG: geometry_msgs/Transform~%# This represents the transform between two coordinate frames in free space.~%~%Vector3 translation~%Quaternion rotation~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: kinect_msgs/SkeletonPositionTrackingState~%int8 NUI_SKELETON_POSITION_NOT_TRACKED = 0~%int8 NUI_SKELETON_POSITION_INFERRED = 1~%int8 NUI_SKELETON_POSITION_TRACKED = 2~%~%~%"))

"""autogenerated by genpy from hg_user_interaction/Gestures.msg. Do not edit."""
import sys
...
import hg_user_interaction.msg
import std_msgs.msg
...
"""
  ...
  _slot_types = ['std_msgs/Header','hg_user_interaction/Gesture[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.gestures:
        ...
        length = len(val1.vars)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *val1.vars))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = hg_user_interaction.msg.Gesture()
        _x = val1
        start = end
        end += 12
        ...
        val1.vars = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.vectors = []
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.vars = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.vectors = []

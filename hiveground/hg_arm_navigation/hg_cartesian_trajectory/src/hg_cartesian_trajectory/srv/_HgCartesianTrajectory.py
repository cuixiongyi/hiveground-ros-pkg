"""autogenerated by genpy from hg_cartesian_trajectory/HgCartesianTrajectoryRequest.msg. Do not edit."""
import sys
...
class HgCartesianTrajectoryRequest(genpy.Message):
  _md5sum = "aa42a55f79f9f94eecf6ea636171f652"
  _type = "hg_cartesian_trajectory/HgCartesianTrajectoryRequest"
...
"""
  ...
  __slots__ = ['header','motion_plan_request','poses','type']
  _slot_types = ['std_msgs/Header','arm_navigation_msgs/MotionPlanRequest','geometry_msgs/Pose[]','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,motion_plan_request,poses,type
    ...
    """
    if args or kwds:
      super(HgCartesianTrajectoryRequest, self).__init__(*args, **kwds)
    ...
    try:
      ...
      for val1 in self.motion_plan_request.goal_constraints.position_constraints:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        _v97 = val1.target_point_offset
        _x = _v97
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v98 = val1.position
        _x = _v98
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v99 = val1.constraint_region_shape
        buff.write(_struct_b.pack(_v99.type))
        length = len(_v99.dimensions)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(_v99.dimensions.tostring())
        length = len(_v99.triangles)
        buff.write(_struct_I.pack(length))
        pattern = '<%si'%length
        buff.write(_v99.triangles.tostring())
        length = len(_v99.vertices)
        buff.write(_struct_I.pack(length))
        for val3 in _v99.vertices:
          _x = val3
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v100 = val1.constraint_region_orientation
        _x = _v100
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_d.pack(val1.weight))
      length = len(self.motion_plan_request.goal_constraints.orientation_constraints)
      ...
      for val1 in self.motion_plan_request.path_constraints.position_constraints:
        ...
        _x = _v119
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v120 = val1.constraint_region_shape
        buff.write(_struct_b.pack(_v120.type))
        length = len(_v120.dimensions)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(_v120.dimensions.tostring())
        length = len(_v120.triangles)
        buff.write(_struct_I.pack(length))
        pattern = '<%si'%length
        buff.write(_v120.triangles.tostring())
        length = len(_v120.vertices)
        buff.write(_struct_I.pack(length))
        for val3 in _v120.vertices:
          _x = val3
          buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _v121 = val1.constraint_region_orientation
        _x = _v121
        buff.write(_struct_4d.pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_struct_d.pack(val1.weight))
      length = len(self.motion_plan_request.path_constraints.orientation_constraints)
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          ...
          val1.link_name = str[start:end]
        _v143 = val1.target_point_offset
        _x = _v143
        start = end
        end += 24
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        _v145 = val1.constraint_region_shape
        start = end
        end += 1
        (_v145.type,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v145.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
        ...
        _v145.triangles = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v145.vertices = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
          _v145.vertices.append(val3)
        _v146 = val1.constraint_region_orientation
        _x = _v146
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
        _v166 = val1.constraint_region_shape
        start = end
        end += 1
        (_v166.type,) = _struct_b.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v166.dimensions = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%si'%length
        ...
        _v166.triangles = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        _v166.vertices = []
        for i in range(0, length):
          ...
          (_x.x, _x.y, _x.z,) = _struct_3d.unpack(str[start:end])
          _v166.vertices.append(val3)
        _v167 = val1.constraint_region_orientation
        _x = _v167
        start = end
        end += 32
        (_x.x, _x.y, _x.z, _x.w,) = _struct_4d.unpack(str[start:end])
...
"""autogenerated by genpy from hg_cartesian_trajectory/HgCartesianTrajectoryResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class HgCartesianTrajectoryResponse(genpy.Message):
  _md5sum = "e8bce043cbe4f5c59cd84daea7835ec3"
  _type = "hg_cartesian_trajectory/HgCartesianTrajectoryResponse"
...
"""
  __slots__ = ['trajectory','error_code','trajectory_error_codes']
  _slot_types = ['arm_navigation_msgs/RobotTrajectory','arm_navigation_msgs/ArmNavigationErrorCodes','arm_navigation_msgs/ArmNavigationErrorCodes[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       trajectory,error_code,trajectory_error_codes
    ...
    """
    if args or kwds:
      super(HgCartesianTrajectoryResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
_struct_2i = struct.Struct("<2i")
_struct_3d = struct.Struct("<3d")
class HgCartesianTrajectory(object):
  _type          = 'hg_cartesian_trajectory/HgCartesianTrajectory'
  _md5sum = 'c1c3b5534f4766c0c2b10933576473c6'
  _request_class  = HgCartesianTrajectoryRequest
  _response_class = HgCartesianTrajectoryResponse

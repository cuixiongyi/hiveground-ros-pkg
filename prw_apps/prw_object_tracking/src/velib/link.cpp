...
{    
    qreal extra = 10;
     ...
     return QRectF(point_out_, QSizeF(point_in_.x() - point_out_.x(),
                                      point_in_.y() - point_out_.y()))
         .normalized()
...
void Link::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, 
    QWidget *widget)
{  

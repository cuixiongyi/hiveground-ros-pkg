...
BCapClient::BCapClient(bool need_crc)
    : m_lAllocCount(0), m_lAllocSize(0), m_iSerialNo(1),
      m_need_crc(need_crc), m_show_debug_packet(false)
{
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_ServiceStart(){
    BCAP_PACKET		*pPacket;
    ...
    if (pPacket != NULL){

        {
            ...
            if (pRecPacket != NULL){
                hr = bCapSendAndRec(pPacket, pRecPacket);
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_ServiceStop(){
    BCAP_PACKET		*pPacket;
    BCAP_PACKET		*pRecPacket;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_ControllerConnect(
    const std::string& pStrCtrlname, 
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_ControllerDisconnect(uint32_t lhController){
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_ControllerGetRobot(uint32_t lhController, char *pStrRobotName, char *pStrOption, uint32_t *plhRobot){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
...
BCAP_HRESULT BCapClient::bCap_ControllerGetVariable(uint32_t lhController, char *pVarName, char *pstrOption, uint32_t *plhVar){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_ControllerGetTask(uint32_t lhController, char *pTskName, char *pstrOption, uint32_t *plhVar){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_ControllerExecute(uint32_t lhController, char *pStrCommand, char *pStrOption, long *plResult){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_RobotRelease(uint32_t lhRobot){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_RobotGetVariable(uint32_t lhRobot, char *pVarName, char *pstrOption, uint32_t *plhVar){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_RobotExecute(uint32_t lhRobot, char *pStrCommand, char *pStrOption, long *plResult){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
...
BCAP_HRESULT BCapClient::bCap_RobotExecute2(uint32_t lhRobot, 
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_RobotChange(uint32_t lhRobot, char *pStrCommand){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_RobotMove(uint32_t lhRobot, long lComp, char *pStrPose, char *pStrOption){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_TaskRelease(uint32_t lhTask){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_TaskGetVariable(uint32_t lhTask, char *pVarName, char *pstrOption, uint32_t *plhVar){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_TaskStart(uint32_t lhTask, long lMode, char *pStrOption){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_TaskStop(uint32_t lhTask, long lMode, char *pStrOption){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *
 */  
BCAP_HRESULT BCapClient::bCap_VariableRelease(uint32_t lhVar){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 */  
BCAP_HRESULT BCapClient::bCap_VariableGetValue(uint32_t lhVar, void *pVntValue){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
 ...
 *	@retval	BCAP_HRESULT
 */  
BCAP_HRESULT BCapClient::bCap_VariablePutValue(uint32_t lhVar, uint16_t iType, uint32_t lArrays, void  *pVntValue){
    BCAP_PACKET		*pSndPacket;
    BCAP_PACKET		*pRecPacket;
    BCAP_ARG		*pArg;
...
BCAP_HRESULT BCapClient::bCapSendAndRec(BCAP_PACKET		*pSndPacket, BCAP_PACKET		*pRecPacket){
 ...
 *
 *	@retval	uint8_t pointer storing recieved packet 
 ...
 *					
 */  
static uint8_t *receivePacket(int iSockFd){
 ...
 *					
 */  
static BCAP_HRESULT sendBinary(uint8_t *pBuff, uint32_t lSize){
 ...
 *
 */  
BCAP_HRESULT BCapClient::Packet_Send(BCAP_PACKET *pPacket){

    BCAP_HRESULT hr = BCAP_E_FAIL;

    void *pbSendData;
    uint32_t length = (m_need_crc) ? (pPacket->lMsgLength + 2) : (pPacket->lMsgLength);
 ...
 *
 */  
BCAP_ARG **BCapClient::Packet_GetLastArgHandle( BCAP_PACKET *pPacket){
 ...
 *
 */  
BCAP_HRESULT BCapClient::Packet_AddArg( BCAP_PACKET *pPacket, BCAP_ARG *pNewArg){
 ...
 *
 */  
void BCapClient::Packet_Release( BCAP_PACKET *pPacket){
 ...
 *
 */  
BCAP_PACKET	*BCapClient::Packet_Create( uint32_t lFuncID){
 ...
 *
 */  
BCAP_HRESULT BCapClient::Packet_Serialize(BCAP_PACKET *pSrcPacket, void *pDstBinData){
    ...
    *pDstPtr = BCAP_SOH;
    ...
    /* Header */
    uint32_t length = (m_need_crc) ? (pSrcPacket->lMsgLength + 2) : (pSrcPacket->lMsgLength);
...
BCAP_HRESULT BCapClient::Packet_Deserialize(void *pSrcBinData, BCAP_PACKET *pDstPacket){
 ...
 */  
BCAP_ARG *BCapClient::Arg_Create( uint16_t iType, uint32_t lArrays, uint32_t lDataSize, void *data){
 ...
 *
 */  
void BCapClient::Arg_Release( BCAP_ARG *pArg){
 ...
 */
uint32_t BCapClient::sizeOfVarType(uint16_t iType){
 ...
 *
 */  
uint32_t BCapClient::copyToBSTR(uint8_t *pDstBstrPtr, const char *pSrcAsciiPtr)
{
 ...
 *
 */   
uint32_t BCapClient::copyFromBSTR(void *pDstAsciiPtr, void *pSrcBstrPtr){
 ...
 */
uint32_t BCapClient::copyValue(void *pDst, void *pVntValue, uint32_t lLength){
 ...
 */
void *BCapClient::bMalloc(size_t size){
 ...
 *	alternative of Free()
 */
void BCapClient::bFree(void *pPtr){

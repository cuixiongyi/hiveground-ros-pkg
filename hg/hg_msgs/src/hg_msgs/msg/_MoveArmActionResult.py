"""autogenerated by genmsg_py from MoveArmActionResult.msg. Do not edit."""
...
class MoveArmActionResult(roslib.message.Message):
  ...
  _type = "hg_msgs/MoveArmActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','hg_msgs/MoveArmResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = hg_msgs.msg.MoveArmResult()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hg_msgs.msg.MoveArmResult()
